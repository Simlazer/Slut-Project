function lightOn() {
    if (document.body.style.background !== "white") {
                ...
                document.getElementById("dropdown").style.background = "white";
                ...
                document.getElementById("li4").style.color = "rgb(80,175,10)";
                document.getElementById("li5").style.color = "rgb(10,100,175)";
                document.getElementById("dropdown").style.background = "rgb(30, 30, 30)";
...
function dropdown_function() {
    ...
    if (document.body.style.background !== "rgb(20, 20, 20)") {
      if (document.body.style.background !== "rgb(100, 100, 100)") {
        if (document.body.style.background !== "white") {
      document.body.style.background = "rgb(20, 20, 20)";
      document.getElementById("gaming_tips").style.color = "rgb(100, 100, 100)";
      document.getElementById("title").style.background = "rgb(10, 10, 10)";
      document.getElementById("colorChange1").style.color = "rgb(100, 100, 100)";
      document.getElementById("colorChange2").style.color = "rgb(100, 100, 100)";
      document.getElementById("colorChange3").style.color = "rgb(100, 100, 100)";
      document.getElementById("colorChange4").style.color = "rgb(100, 100, 100)";
      document.getElementById("colorChange5").style.color = "rgb(100, 100, 100)";
    ...
    document.getElementById("title").style.background = "rgb(20, 20, 20)";
    document.getElementById("colorChange1").style.color = "black";
    document.getElementById("colorChange2").style.color = "black";
    document.getElementById("colorChange3").style.color = "black";
    document.getElementById("colorChange4").style.color = "black";
